...
public class OnlineDioAuthenticator extends AbstractAccountAuthenticator
{
    ...
    {
        Log.d("OnlineDio", TAG + "> addAccount");
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException
    {
        ...
        Log.d("OnlineDio", TAG + "> getAuthToken");
        ...
        Log.d("OnlineDio", TAG + "> peekAuthToken returned - " + authToken);
        ...
        if (TextUtils.isEmpty(authToken))
        {
            ...
            if (password != null)
            {
                try
                {
                    Log.d("OnlineDio", TAG + "> re-authenticating with the existing password");
